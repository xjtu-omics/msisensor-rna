...
def args_process():
    ...
    parser_train.add_argument('-m', '--model', required=True, type=str, nargs=1,
                                  help="The path of the model [required]")
    parser_train.add_argument('-o', '--output', required=True, type=str, nargs=1,
                                  help="The path of output file prefix [required]")
    parser_train.add_argument("-c", "--custom", required=False, type=str,default=["False"], nargs=1,
                                  choices=["True", "False"],
                                  help="Use custom model, default value [False].")
    parser_train.add_argument("-cm", "--custom_model", type=str, nargs=1,default=["."],
                                  help="Path of custom model, required if --custom=True.")
    parser_train.add_argument("-t", "--cancer_type", required=False, type=str, nargs=1, default=["CRC"],
